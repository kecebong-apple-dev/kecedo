...
class TaskModel: Identifiable {
    ...
    // Memberikan nilai default `false` pada isDone agar lebih rapi saat inisialisasi
    init(id: UUID = UUID(), title: String, desc: String, startDate: Date, endDate: Date, priority: Priority, isDone: Bool = false) {
        self.id = id
        self.title = title
        self.desc = desc
    ...
    static var dummyTasks: [TaskModel] {
        ...
        return [
            ...
            TaskModel(title: "Submit MoU document for Academy program", desc: "Need to upload the signed document to the portal before the deadline closes.", startDate: now, endDate: now.addingTimeInterval(7200), priority: .doFirst, isDone: false), // Due 2 jam lagi
            ...
            TaskModel(title: "Draft final project: Sistem Manajemen Tugas Terintegrasi Cuaca", desc: "Complete the first 3 chapters of the thesis.", startDate: now, endDate: now.addingTimeInterval(86400 * 2), priority: .doFirst, isDone: true),
            TaskModel(title: "Review pull request from team member", desc: "Check the new SwiftUI components.", startDate: now, endDate: now.addingTimeInterval(18000), priority: .doFirst, isDone: true),
            ...
            TaskModel(title: "Watch tutorial series on advanced Ionic Vue integration", desc: "Need this for the cross-platform app module.", startDate: now, endDate: now.addingTimeInterval(86400 * 5), priority: .schedule, isDone: true),
            ...
            TaskModel(title: "Buy groceries and snacks for the week", desc: "Milk, eggs, bread, coffee.", startDate: now, endDate: now.addingTimeInterval(-7200), priority: .delegate, isDone: true),
            ...
            TaskModel(title: "Check specifications for new tech rumors", desc: "I already have good devices.", startDate: now, endDate: now.addingTimeInterval(86400 * 4), priority: .eliminate, isDone: true),
